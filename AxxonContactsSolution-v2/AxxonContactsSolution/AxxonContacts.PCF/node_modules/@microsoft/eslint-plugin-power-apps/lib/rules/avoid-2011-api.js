...
module.exports = {
    meta: {
        ...
        docs: {
            ...
            recommended: true,
            url: "https://learn.microsoft.com/power-apps/maker/data-platform/powerapps-checker/rules/web/avoid-2011-api"
        },
    ...
    create(context) {
        ...
        const reporter = function (context, node, isMatchedProperty, data, snippet) {
            ...
            // https://learn.microsoft.com/powerapps/developer/model-driven-apps/clientapi/reference/getglobalcontext-clientglobalcontext.js.aspx
